...
Implementing your own operations is more advanced than in other crates. Examples of such can be found in the source code of `ferrograd-nn` or the README of `fused_gpu`.
